...
class SellerStoreDetailPage extends StatefulWidget {
  final Store? store;
  const SellerStoreDetailPage({super.key, required this.store});

  @override
  State<SellerStoreDetailPage> createState() => _SellerStoreDetailPageState();
}

class _SellerStoreDetailPageState extends State<SellerStoreDetailPage> {
