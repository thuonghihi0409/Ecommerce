...
class _DashboardTabState extends State<DashboardTab>
  ...
  _getData() async {
    final storeId = context.read<ProfileBloc>().state.store?.id ?? "";
    if (widget.type == "day") {
      _dashboardBloc.add(GetStatisticDay(storeId: storeId));
    }
    if (widget.type == "month") {
      _dashboardBloc.add(GetStatisticMonth(storeId: storeId));
    }
    if (widget.type == "year") {
      _dashboardBloc.add(GetStatisticYear(storeId: storeId));
    }
  }
