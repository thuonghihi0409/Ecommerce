...
class OrderManagementState extends Equatable {
  ...
  final ListModel<SellerOrderItem> listOrderReturnRequested; // Yêu cầu trả hàng
  final ListModel<SellerOrderItem> listOrderReturned; // Đã trả hàng
  ...
  OrderManagementState copyWith({
    ...
    ListModel<SellerOrderItem>? listOrderReturnRequested,
    ListModel<SellerOrderItem>? listOrderReturned,
    bool? isGetDetail,
    bool? isLoading,
    bool? isLoadingMore,
    bool? isRefreshing,
